...
export default function SearchBar() {
  ...
  return (
    <div className="relative" ref={searchRef}>
      ...
      {/* 🌟 1. LIGHTER FULL PAGE BACKDROP OVERLAY (Lighter tint with beautiful blur balance) */}
      <div 
      ...
      <div 
        className={`fixed top-[75px] left-4 right-4 md:absolute md:top-auto md:left-auto md:right-0 mt-3 w-auto md:w-85 bg-[#3a2e28]/95 backdrop-blur-xl border border-white/10 rounded-none shadow-[0_20px_50px_rgba(0,0,0,0.25)] p-5 z-[99999] transform origin-top transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] ${
          isSearchOpen 
      ...
      >
        ...
        {/* Dynamic Results Menu (Inner search rows are kept clean & sharp) */}
        {searchQuery.trim() && (
          <div className="mt-4 max-h-64 overflow-y-auto space-y-1 font-sans divide-y divide-white/5 pt-1 scrollbar-thin scrollbar-thumb-white/10">
            {isSearching ? (
              ...
              searchResults.map((product) => (
                <div 
                  ...
                  className="group pt-2.5 pb-2 text-left cursor-pointer flex justify-between items-center hover:bg-white/5 px-3 rounded-none transition-all duration-300"
                >
                  ...
                  <span className="text-[11px] font-medium text-[#fdfbf7]/80 tracking-wider">
